...
public class MomentDetialActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		editButton.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				Intent intent = new Intent(MomentDetialActivity.this,
						MomentEditActivity.class);
		...
		commentButton.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				// Intent intent = new Intent(MomentFragment.this.getActivity(),
		...
		commentCommit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Comment comment = new Comment(HomeFragment.userName, desc,
						HomeFragment.userPicture, date);

				if (TextUtils.isEmpty(desc.trim())) {
					Toast.makeText(v.getContext(), "Say something!",
	...
	public void getComment() {
		...
		try {
			...
			for (int i = 0; i < len; i++) {
				...
				String date = StringTools.dateFormat(comjsonObj
						.getString("date"));
	...
	public void addComment(Comment comment) {
		...
		client.post(MomentDetialActivity.this, url, stringEntity,
				"application/json", new AsyncHttpResponseHandler() {
					...
					public void onSuccess(int statusCode, Header[] headers,
						...
						Toast.makeText(MomentDetialActivity.this,
								"Add a new comment", Toast.LENGTH_LONG).show();
					...
					public void onFailure(int statusCode, Header[] headers,
						...
						Toast.makeText(MomentDetialActivity.this, resResult,
								Toast.LENGTH_LONG).show();
